              ...
              {overriding === b.category && (
                <div className="mt-2 space-y-1.5 border-t border-red-200 pt-2">
                  ...
                  <div className="flex gap-2">
                    <button onClick={submitOverride} disabled={!canSubmit} className="px-2.5 py-1 text-[11px] border border-line text-ink rounded hover:bg-surface disabled:opacity-50">

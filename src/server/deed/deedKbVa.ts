...
export const VA_EXEMPTIONS: readonly VaExemption[] = [
  ...
  { citation: 'Va. Code § 58.1-811(A)(15)', transferType: 'When it is a deed transferring property pursuant to a decree of divorce or of separate maintenance or pursuant to a written instrument incident to such divorce or separation.', watchOuts: 'Divorce/separation-incident transfer. The C2 divorce-into-trust variant cites this ALONGSIDE (A)(12) (a divorced grantor moving former-TBE property into a revocable trust). Verbatim from Va. Code § 58.1-811(A)(15) (operator-supplied 2026-06-24).' },
